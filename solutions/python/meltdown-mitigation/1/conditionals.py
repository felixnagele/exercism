...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    overload_amount: float = temperature * neutrons_produced_per_second
    
    if overload_amount < 0.9 * threshold:
        return 'LOW'
    elif overload_amount >= 0.9 * threshold and overload_amount <= 1.1 * threshold:
        return 'NORMAL'
    else:
        return 'DANGER'
